...
# MAKE SURE NOT TO RUN DIRECTLY AS ROOT OR THE SHORTCUTS WON'T WORK!!!
if [ $EUID -ne 0 ]; then
	shortcuts="$HOME/Desktop"
	echo $shortcuts

	cat <<EOF > "$shortcuts/firefox_firefox.desktop"
	[Desktop Entry]
	...
	Comment[ach]=Fast and private browser
	Comment[af]=Fast and private browser
	Comment[an]=Fast and private browser
	Comment[ar]=متصفح سريع وخاص
	Comment[ast]=Fast and private browser
	Comment[az]=Fast and private browser
	Comment[be]=Хуткі і прыватны браўзер
	Comment[bg]=Fast and private browser
	Comment[bn]=Fast and private browser
	Comment[br]=Fast and private browser
	Comment[bs]=Fast and private browser
	Comment[ca]=Navegador ràpid i privat
	Comment[cak]=Fast and private browser
	Comment[cs]=Rychlý a soukromý prohlížeč
	Comment[cy]=Porwr cyflym a phreifat
	Comment[da]=Hurtig og privat browser
	Comment[de]=Schneller und privater Browser
	Comment[dsb]=Malsny a priwatny wobglědowak
	Comment[el]=Γρήγορο και ιδιωτικό πρόγραμμα περιήγησης
	Comment[en_CA]=Fast and private browser
	Comment[en_GB]=Fast and private browser
	Comment[eo]=Rapida kaj privata retumilo
	Comment[es_AR]=Navegador rápido y privado
	Comment[es_CL]=Navegador rápido y privado
	Comment[es_ES]=Navegador rápido y privado
	Comment[es_MX]=Navegación web rápida y privada
	Comment[et]=Fast and private browser
	Comment[eu]=Fast and private browser
	Comment[fa]=Fast and private browser
	Comment[ff]=Fast and private browser
	Comment[fi]=Nopea ja yksityinen selain
	Comment[fr]=Navigateur rapide et privé
	Comment[fur]=Navigadôr svelt e riservât
	Comment[fy_NL]=Flugge en priveebrowser
	Comment[ga_IE]=Fast and private browser
	Comment[gd]=Fast and private browser
	Comment[gl]=Fast and private browser
	Comment[gn]=Kundahára ipya’e ha hekoñemíva
	Comment[gu_IN]=Fast and private browser
	Comment[he]=דפדפן מהיר ופרטי
	Comment[hi_IN]=Fast and private browser
	Comment[hr]=Fast and private browser
	Comment[hsb]=Spěšny a priwatny wobhladowak
	Comment[hu]=Gyors és privát böngésző
	Comment[hy_AM]=Արագ և անձնական դիտարկիչ
	Comment[ia]=Navigator veloce e private
	Comment[id]=Fast and private browser
	Comment[is]=Fast and private browser
	Comment[it]=Browser veloce e riservato
	Comment[ja]=高速プライベートブラウザー
	Comment[ka]=სწრაფი და პირადი ბრაუზერი
	Comment[kab]=Iminig arurad, uslig
	Comment[kk]=Жылдам және жеке браузер
	Comment[km]=Fast and private browser
	Comment[kn]=Fast and private browser
	Comment[ko]=빠르고 사생활을 보호하는 브라우저
	Comment[lij]=Fast and private browser
	Comment[lt]=Fast and private browser
	Comment[lv]=Fast and private browser
	Comment[mk]=Fast and private browser
	Comment[mr]=Fast and private browser
	Comment[ms]=Fast and private browser
	Comment[my]=Fast and private browser
	Comment[nb_NO]=Rask og privat nettleser
	Comment[ne_NP]=Fast and private browser
	Comment[nl]=Snelle en privébrowser
	Comment[nn_NO]=Rask og privat nettlesar
	Comment[oc]=Fast and private browser
	Comment[pa_IN]=Fast and private browser
	Comment[pl]=Szybka i prywatna przeglądarka
	Comment[pt_BR]=Navegador rápido e privativo
	Comment[pt_PT]=Fast and private browser
	Comment[rm]=Navigatur svelt e privat
	Comment[ro]=Browser rapid și privat
	Comment[ru]=Быстрый и приватный браузер
	Comment[sat]=Fast and private browser
	Comment[sc]=Navigadore lestru e privadu
	Comment[sco]=Fast and private browser
	Comment[si]=Fast and private browser
	Comment[sk]=Rýchly a súkromný prehliadač
	Comment[skr]=Fast and private browser
	Comment[sl]=Hiter in zaseben brskalnik
	Comment[son]=Fast and private browser
	Comment[sq]=Fast and private browser
	Comment[sr]=Fast and private browser
	Comment[sv_SE]=Snabb och privat webbläsare
	Comment[szl]=Fast and private browser
	Comment[ta]=Fast and private browser
	Comment[te]=Fast and private browser
	Comment[tg]=Браузери тезкор ва хусусӣ
	Comment[th]=เบราว์เซอร์ที่รวดเร็วและเป็นส่วนตัว
	Comment[tl]=Fast and private browser
	Comment[tr]=Hızlı ve gizli tarayıcı
	Comment[trs]=Fast and private browser
	Comment[uk]=Швидкий і приватний браузер
	Comment[ur]=Fast and private browser
	Comment[uz]=Fast and private browser
	Comment[vi]=Trình duyệt nhanh và riêng tư
	Comment[xh]=Fast and private browser
	Comment[zh_CN]=快速且私密的浏览器
	Comment[zh_TW]=快速又有隱私的瀏覽器
	...
	Name[zh_TW]=開啟設定檔管理員
EOF
	chmod +x $shortcuts/firefox_firefox.desktop
...
EOF
	chmod +x $shortcuts/Naksu2.desktop

	echo "Created server utility"
fi
...
echo "Signed-By: /etc/apt/trusted.gpg.d/ytl-linux.asc" | sudo tee -a /etc/apt/sources.list.d/ytl-linux.sources
